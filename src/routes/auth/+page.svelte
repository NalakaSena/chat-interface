...
{#if loaded}
	<div>
		<div
			class="bg-container bg-white dark:bg-gray-950 min-h-screen w-full flex justify-center font-primary"
		>
			<div class="bg-filter dark:bg-filter w-full flex justify-center font-primary">
				<div class="w-full sm:max-w-md px-10 min-h-screen flex flex-col text-center">
					{#if ($config?.features.auth_trusted_header ?? false) || $config?.features.auth === false}
						<div class=" my-auto pb-10 w-full">
							...
							>
								<div>
									<img src="../../assets/images/bg-image.jpg" alt="logo" />
								</div>
								<div>
									...
									<div class="flex flex-col mt-4">
										...
										<div class="mb-2">
											...
											<input
												bind:value={email}
												type="email"
												class=" px-5 py-3 rounded-xl w-full text-sm outline-none border dark:border-none dark:bg-gray-900"
												autocomplete="email"
